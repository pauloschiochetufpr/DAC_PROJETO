...
public class RebootListener {
    ...
    public void onReboot(String mensagem) {
        try {
            ...
            usuarios.add(new HashMap<>(Map.of("cpf","52998224725","email","cli6@bantads.com.br","senhaHash","tads","tipo","cliente")));
            ...
            usuarios.add(new HashMap<>(Map.of("cpf","11144477735","email","ger4@bantads.com.br","senhaHash","tads","tipo","gerente")));
            usuarios.add(new HashMap<>(Map.of("cpf","40501740066","email","adm1@bantads.com.br","senhaHash","tads","tipo","administrador")));
            usuarios.add(new HashMap<>(Map.of("cpf","40730217027","email","adm2@bantads.com.br","senhaHash","tads","tipo","administrador")));
